...
@synthesize ediatable = _ediatable;
...
-(void)layoutSubviews {
    ...
    for (int i = 0; i < self.imageViews.count; i++) {
        ...
        UIImageView *imageView = [self.imageViews objectAtIndex:i];
        CGRect imageFrame = CGRectMake(self.leftMargin + i * (self.leftMargin + imageWidth), 0, imageWidth, imageHeight);
